...
* @version 2.1.10
*
* Patch by dthenon@emencia.com for:
* - Removed invalid 'frameborder' on iframe element;
* - Changed reponsive behavior to simply use a div with
*   'responsive-embed widescreen' classes and no inline styles anymore;
*/
(function () {
